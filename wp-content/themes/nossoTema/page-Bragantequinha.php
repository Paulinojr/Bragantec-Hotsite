...
<div class="row">
  ...
  <div class="row imagensBragantequinha">
  ...
  <div class="row imagensBragantequinha">
    <div class="one-third column">
      <a class="fancy" rel="bragantequinha" href="<?php echo get_stylesheet_directory_uri(); ?>/img/bragantequinha (4).jpg">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/bragantequinha (4).jpg" alt="Imagens das crianças na bragantequinha" />
      </a>
    </div>
  </div>
</div>
