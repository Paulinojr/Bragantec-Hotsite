<footer>
	<div class="row">
		<!--  ****************** Informaçoes ********************************* -->
		<div class="four columns footerDivs" id="contato">
		...
		<div class="four columns footerDivs desenvolvedores">
			...
			<div style="padding-left: 20px;">
				<div class="four columns">
					<div class="imgDesenvolvedores">
						<div style="position: relative;">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/bia.jpg"  alt="Imagem da desenvolvedora Beatriz Miranda"/>
				...
				<div class="four columns">
					<div class="imgDesenvolvedores">
						<div style="position: relative;">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/laura.jpg"  alt="Imagem da desenvolvedora Laura Chaile"/>
				...
				<div class="four columns">
					<div class="imgDesenvolvedores">
						<div style="position: relative;">
							<img src="<?php echo get_stylesheet_directory_uri();?>/img/paulino.jpeg" alt="Imagem do desenvolvedor Paulino Junior"/>
